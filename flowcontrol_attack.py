...
# Adjustment: Importing H3Connection with adjusted FlowControl Setting.
from Attacker import H3ConnectionFlowControl
...
HttpConnection = Union[H0Connection, H3Connection, H3ConnectionFlowControl]
...
class HttpClient(QuicConnectionProtocol):
    def __init__(self, *args, **kwargs) -> None:
        ...
        # Adjustment: Using adjusted Class instead of H3Connection
        if self._quic.configuration.alpn_protocols[0].startswith("hq-"):
            self._http = H0Connection(self._quic)
        else:
            self._http = H3ConnectionFlowControl(self._quic)
